        ...
        <>
            ...
            <div>
                ...
                <h5 className="welcome-subtitle">
                    ...
                    find services, food & stay up to date with the latest news
                </h5>
            </div>
        </>
    )
...
export const WelcomeYourPassion = () => {
    return (
        <>
        ...
        <>
            ...
            <div>
                ...
                <h5 className="welcome-subtitle">
                    ...
                    with shared interests. Create unforgettable memory
                </h5>
            </div>
        </>
    )
