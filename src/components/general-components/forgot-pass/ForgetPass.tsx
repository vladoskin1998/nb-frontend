    ...
    return (
        <div className="forget">
            ...
            <Routes >
                ...
                <Route path='code' element={<CheckCode email={email} phone={phone}/>} />
                <Route path='recovery' element={<Recovery />} />
                <Route path='*' element={<ForgetPassBody email={email} phone={phone}/>} />
            </Routes>
...
const ForgetPassBody = ({email,phone}: {email:string, phone:string}) => {
    ...
    const navigate = useNavigate()
    const [method, setMethod] = useState<METHOD_FORGET_PASSWORD>(METHOD_FORGET_PASSWORD.PHONE)
    ...
    return <>
        ...
        <div className={`forget__body-method ${method === METHOD_FORGET_PASSWORD.PHONE ? "forget__body-method--active" : ""}`}
         onClick={() => { setMethod(METHOD_FORGET_PASSWORD.PHONE) }}>
        ...
        <div className={`forget__body-method-2 forget__body-method ${method === "email" ? "forget__body-method--active" : ""}`} 
        onClick={() => { setMethod(METHOD_FORGET_PASSWORD.EMAIL)}}>
            <div className="forget__body-method-icon">
                <IconsMessage />
            </div>
            <div>
